...
<xsl:param    name="dateReport" select="java:format(java:java.text.SimpleDateFormat.new('yyyy-MMM-dd HH:MM'), java:java.util.Date.new())" />
			...
			<tr valign="top">
				...
				<td align="center">
				   <a href="">
			         ...
			         <table class="inlinedetails" bordercolor="#000000" bgcolor="#2674A6" border="0"  cellpadding="1" cellspacing="1" width="95%">
			         <tr>
			            	<th>request</th>
					<th>response</th>
			         </tr>
